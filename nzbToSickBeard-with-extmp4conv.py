...
def main():
    ...
    path_of_nzbtosickbeardpy = os.path.abspath(os.path.join(nzbtomediadirectory,'nzbToSickBeard.py'))
    ...
    postprocessing = Subprocesslauncher(path_to_python,path_of_nzbtosickbeardpy,sys.argv[1:],terminalprefix='NZBTOSICKBEARD    ')
